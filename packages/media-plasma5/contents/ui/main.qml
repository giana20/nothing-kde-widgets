...
import org.kde.plasma.private.mpris 1.0 as Mpris
...
Item {
    ...
    // Media properties
    readonly property string track: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.track : ""
    readonly property string artist: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.artist : ""
    readonly property string album: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.album : ""
    readonly property string albumArt: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.artUrl : ""
    readonly property string playerIconName: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.iconName : ""
    readonly property int playbackStatus: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.playbackStatus : 0
    readonly property bool isPlaying: root.playbackStatus === Mpris.PlaybackStatus.Playing
    readonly property bool canGoPrevious: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.canGoPrevious : false
    readonly property bool canGoNext: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.canGoNext : false
    readonly property bool canPlay: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.canPlay : false
    readonly property bool canPause: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.canPause : false
    readonly property real length: mpris2Model.currentPlayer ? mpris2Model.currentPlayer.length : 0
    ...
    Connections {
        ...
        function onPositionChanged() {
            root.position = mpris2Model.currentPlayer ? mpris2Model.currentPlayer.position : 0
        }
    }
